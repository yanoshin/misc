...
function popupSetCookie(value,exdays)
{
    var c_name = "wpn-popupunder";
    var exdate=new Date();
...
if (!val) {
    (function() {
        ...
        tn.async = true;
        tn.src = 'http://www.loading-delivery1.com/popupshow/xvideos/' + window.wpn_categories;
        var s = document.getElementsByTagName('embed')[0];
